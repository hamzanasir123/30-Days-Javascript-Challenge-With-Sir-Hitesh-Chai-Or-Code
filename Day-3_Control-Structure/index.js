...
var number = Math.max(23, 54, 855, 732, 540);
console.log(number);
if (number != 23) {
    if (number != 54) {
        if (number != 855) {
...
console.log("The grade for a score of ".concat(score, " is: ").concat(grade));
...
var numcheck = 40;
if (numcheck % 2 == 0) {
    console.log("".concat(numcheck, " is Even!"));
}
else {
    console.log("".concat(numcheck, " is Odd!"));
}
